...
Java_com_sun_opencv_1face_FaceDetector_loadCascade(JNIEnv *env, jobject thiz, jstring filePath_) {
...
JNIEXPORT int
JNICALL
Java_com_sun_opencv_1face_FaceDetector_faceDetectSave(JNIEnv *env, jobject thiz,
                                                      jobject bitmap);
// bitmap -> mat
...
Java_com_sun_opencv_1face_FaceDetector_faceDetectSave(JNIEnv *env, jobject thiz, jobject bitmap) {
