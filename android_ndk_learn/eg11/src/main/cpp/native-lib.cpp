...
Java_com_sun_eg11_GifHandler_getWidth(JNIEnv *env, jclass type, jlong ndkGif) {
...
extern "C"
JNIEXPORT jint JNICALL
Java_com_sun_eg11_GifHandler_updateFrame(JNIEnv *env, jclass type, jobject bitmap,
                                                   jlong ndkGif) {
